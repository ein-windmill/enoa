 ...
 */
package io.enoa.repeater.factory.provider;
...
public interface EoxProviderFactory {
   ...
   * 错误渲染
   *
   * @return EoxErrorRenderFactory
   */
  EoxErrorRenderFactory errorRender();
