...
import io.enoa.repeater.provider.netty.server.NettyProvider;

public class NettyRepeater extends AbstractRepeaterExample {

  public static void main(String[] args) {
    NettyRepeater repeater = new NettyRepeater();
    repeater.start();
  }
