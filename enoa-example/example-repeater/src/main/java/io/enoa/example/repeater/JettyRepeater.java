...
import io.enoa.repeater.provider.jetty.server.JettyProvider;
import io.enoa.toolkit.map.Kv;

public class JettyRepeater extends AbstractRepeaterExample {

  public static void main(String[] args) {
    JettyRepeater repeater = new JettyRepeater();
    repeater.start();
  }
