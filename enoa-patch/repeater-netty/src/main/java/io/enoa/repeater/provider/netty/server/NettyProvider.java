...
import io.enoa.repeater.provider.netty.ts.NettyTranslateProvider;

public class NettyProvider implements RepeaterServerFactory {
  @Override
  public String name() {
    return "Netty";
  }
  ...
  public RepeaterServer server(EoxAccessor accessor) {
    return new _Netty(accessor);
  }

  @Override
  public RepeaterTranslateFactory ts() {
    return new NettyTranslateProvider();
  }
}
