...
class JettyCosRequestWrapper extends EoxAbstractCosRequest {
  ...
  JettyCosRequestWrapper(HttpServletRequest request, EoxConfig config, EoxNameRuleFactory rule) throws IOException {
