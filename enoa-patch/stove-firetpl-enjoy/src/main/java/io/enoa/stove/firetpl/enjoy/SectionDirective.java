...
public class SectionDirective extends Directive {
  ...
  public void setExprList(ExprList exprList) {
    if (exprList.length() == 0) {
      throw new ParseException("The parameter of #block directive can not be blank", location);
    }
    ...
    if (expr instanceof Const && ((Const) expr).isStr()) {
      ...
      throw new ParseException("The parameter of #block directive must be String", location);
    }
