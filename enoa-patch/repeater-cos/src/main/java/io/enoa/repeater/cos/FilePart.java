...
public class FilePart extends Part {
   ...
   */
  FilePart(String name, EoxInputStream in, String boundary,
   ...
   * @throws IOException if an input or output exception has occurred.
   */
  public long writeTo(String path, String newname) throws IOException {
    long written = 0;

    OutputStream fileOut = null;
    try {
      if (newname == null || "".equals(newname))
        throw new IOException("Write file name can not be null.");
      ...
      if (fileName != null) {
        ...
        if (!fileOrDirectory.isDirectory())
          throw new IOException("Write path is not a directory.");
