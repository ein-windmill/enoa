...
public class MultipartParser {
   ...
   *
   * @param body    the servlet request.
   * @param maxSize the maximum size of the POST content.
   */
  public MultipartParser(MultipartBody body,
                         int maxSize) throws IOException {
    this(body, maxSize, true, true);
  }
   ...
   */
  public MultipartParser(MultipartBody body, int maxSize, boolean buffer,
                         boolean limitLength) throws IOException {
    this(body, maxSize, buffer, limitLength, null);
  }
