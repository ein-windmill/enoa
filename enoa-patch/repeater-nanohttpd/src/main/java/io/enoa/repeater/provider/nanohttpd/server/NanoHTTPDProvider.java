...
import io.enoa.repeater.provider.nanohttpd.ts.NanoHTTPDTranslateProvider;

public class NanoHTTPDProvider implements RepeaterServerFactory {
  ...
  public RepeaterServer server(EoxAccessor accessor) {
    return new _NanoHTTPD(accessor);
  }

  @Override
  public RepeaterTranslateFactory ts() {
    return new NanoHTTPDTranslateProvider();
  }
}
