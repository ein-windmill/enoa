...
public class DQPNetworkPrune implements DQP {
  ...
  public DQPNetworkPrune() {
  }

  public DQPNetworkPrune filters(String filter) {
  ...
  public DQPNetworkPrune filters(List<String> filters) {
