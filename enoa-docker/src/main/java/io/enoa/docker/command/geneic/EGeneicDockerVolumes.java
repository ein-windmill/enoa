...
import io.enoa.docker.command.origin.EOriginDockerVolumes;
import io.enoa.docker.command.origin.OriginDocker;

public class EGeneicDockerVolumes {

  private OriginDocker docker;
  private DockerConfig config;
  private EOriginDockerVolumes volumes;

  EGeneicDockerVolumes(OriginDocker docker) {
    this.docker = docker;
