...
public class FreemarkerConfig implements EoEngineConfig {
  ...
  private final Map autoImports;

  private FreemarkerConfig(Builder builder) {
    ...
    this.autoImports = builder.autoImports;
  }

  FreemarkerConfig(EoEngineConfig config) {
  ...
  public static class Builder {
    ...
    public Builder autoImports(Map autoImports) {
