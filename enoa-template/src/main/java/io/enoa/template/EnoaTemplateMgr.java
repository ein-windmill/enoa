...
//
////  public static void defTemplateFactory(EoTemplateFactory factory) {
////    EnoaTemplateMgr.factory = factory;
////  }
////
////  public static void defConfig(EoEngineConfig config) {
////    EnoaTemplateMgr.config = config;
////  }
//
//  private static EnoaEngine ENGINE;
//
//  public static void defEngine(EoTemplateFactory factory, EoEngineConfig config) {
//    if (config == null) {
//      config = new EoEngineConfig() {
//        @Override
//        public String name() {
//          return "main";
//        }
...
//  }
//
//  public static EnoaEngine defEngine() {
//    return ENGINE;
//  }
//}
