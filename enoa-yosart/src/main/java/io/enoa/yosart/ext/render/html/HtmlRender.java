 ...
 */
package io.enoa.yosart.ext.render.html;
...
class HtmlRender implements YoRender {
  ...
  HtmlRender(Request req, Kv attr, Object[] args) {
    this.req = req;
    this.attr = attr;
    this.html = (String) args[0];
  ...
  public ResponseBody render() {
    return ResponseBody.create(this.html, this.charset);
  }
}
